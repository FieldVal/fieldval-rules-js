To use FieldVal Rules in the browser without a package manager, download ```fieldval.js```, ```fieldval-ui.js``` and ```fieldval-rules.js``` or their minified versions from their respective repositories:
